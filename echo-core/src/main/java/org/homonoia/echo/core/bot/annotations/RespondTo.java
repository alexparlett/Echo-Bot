package org.homonoia.echo.core.bot.annotations;
...
public @interface RespondTo {
    /**
     * <p>The regex string to match on the message. Based on SPeL with the {@link OutgoingWebhookPayload}
    ...
    /**
     * <p>The regex string to match on the channel. Based on SPeL with the {@link OutgoingWebhookPayload} as
     * the root object.</p>
     * e.g.
