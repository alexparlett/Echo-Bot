...
public class HearListenerFactory implements EventListenerFactory, Ordered, ApplicationContextAware {
    ...
    public HearListenerFactory(HipchatProperties hipchatProperties) {
    ...
    public ApplicationListener<?> createApplicationListener(String beanName, Class<?> type, Method method) {
        return new HearApplicationListenerMethodAdapter(beanName, type, method,evaluator,applicationContext,hipchatProperties);
    }
